...
import random, matplotlib.pyplot as plt      # Import modules needed for code
...
# Make a line plot of the results
plt.plot(dieRoll[numberofDicetoRoll:], results[numberofDicetoRoll:])
plt.xlabel('Sum of Dice')
plt.ylabel('Number of Rolls')
plt.title('Results of rolling {} dice 1,000,000 times'.format(numberofDicetoRoll))
